...
struct VehicleConfig {
    ...
    std::vector<std::pair<int, float>> torqueCurve = {
        {3000, 20.0},  {3500, 56.0},  {4000, 62.5},  {4500, 62.5}, {5000, 66.0},
        {5500, 67.0},  {6000, 64.0},  {6500, 64.0},  {7000, 66.0}, {7500, 65.0},
        {8000, 66.0},  {8500, 65.0},  {9000, 63.0},  {9500, 63.0}, {10000, 62.5},
        {10500, 60.0}, {11000, 58.0}, {11500, 56.0}, {12000, 50.0}};
