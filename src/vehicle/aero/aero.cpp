...
void Aero::calculateTorques(VehicleState state, float airDensity, PolarVec3 wind) {
    yawingTorque(state, airDensity, wind);
    rollingTorque(state, airDensity, wind);
    pitchingTorque(state, airDensity, wind);
}

void Aero::yawingTorque(VehicleState state, float airDensity, PolarVec3 wind) { return; }
void Aero::rollingTorque(VehicleState state, float airDensity, PolarVec3 wind) { return; }
void Aero::pitchingTorque(VehicleState state, float airDensity, PolarVec3 wind) { return; }

void Aero::calculateForces(VehicleState state, float airDensity, PolarVec3 wind) {
    resistance(state, airDensity, wind);
    sideForce(state, airDensity, wind);
    downforce(state, airDensity, wind);
}

void Aero::resistance(VehicleState state, float airDensity, PolarVec3 wind) {}
