...
TireSimple::TireSimple(float scalingFactor, float quadFac, float linFac, bool isDriven) : Tire(scalingFactor, quadFac, linFac, isDriven) {}
...
float TireSimple::getLatrealForce(float verticalLoad){
